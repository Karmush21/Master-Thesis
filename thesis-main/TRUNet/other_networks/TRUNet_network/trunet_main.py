...
from ViT import VisionTransformer3d as TransUNet3d
from datetime import datetime
from trunet_train import trainer
from torchvision import transforms
from augmentations import RandomGenerator3d_zoom, Reshape3d_zoom
...
if __name__ == "__main__":
    ...
    model = TransUNet3d(config_net, img_size=args.img_size, zero_head=False,
                        vis=False)
