...
from other_networks.TRUNet_network_no_vit.decoder_cup import DecoderCup3d
from other_networks.TRUNet_network_no_vit.segmentation_head import SegmentationHead3d
#from transformer import Transformer3d
from other_networks.TRUNet_network_no_vit.transformer import Transformer3d
...
class VisionTransformer3d(nn.Module):
    def __init__(self, config, img_size=224, zero_head=False, vis=False):
        ...
        self.transformer = Transformer3d(config, img_size, vis) #this is the cnn and transformer in one
