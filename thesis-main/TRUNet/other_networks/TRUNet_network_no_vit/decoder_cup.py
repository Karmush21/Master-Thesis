...
from other_networks.TRUNet_network_no_vit.ConvReLU import Conv3dReLU
from other_networks.TRUNet_network_no_vit.decoder_block import DecoderBlock3d
...
class DecoderCup3d(nn.Module):  # cascade upsampler
    def __init__(self, config):
        ...
        #This is changed now because we dont use transformer anymore, so no more 1024 to 512.
        self.conv_more = Conv3dReLU(
            1024,  # these are the inchannels
            512,  # these are the outchannels
            kernel_size=3,
            padding=1,
            stride=1,
            use_batchnorm=True,
